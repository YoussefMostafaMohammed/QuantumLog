...
def _load_dependencies_impl(mctx):
    conan_dependency_repo(
        name = "spdlog",
        package_path = "/home/youssef/.conan2/p/spdloc328dfc1eb52d/p",
        build_file_path = "/home/youssef/modernC++/QuantumLog/.conan/spdlog/BUILD.bazel",
    )
    conan_dependency_repo(
        name = "fmt",
        package_path = "/home/youssef/.conan2/p/fmt1cd708a4e8cfe/p",
        build_file_path = "/home/youssef/modernC++/QuantumLog/.conan/fmt/BUILD.bazel",
    )
